...
SKILL_PROFILES = {
    ...
    "agv": {
        ...
        "runner": (
            ...
            "# Force AGV template - call gen_step() defined by LLM\n"
            "try:\n"
            "    _result = gen_step()\n"
            "    if _result and os.path.exists(str(_result)):\n"
            "        # Copy to output_dir/output.step for the pipeline\n"
            "        import shutil\n"
            "        _dest = os.path.join(output_dir, 'output.step')\n"
            "        shutil.copy2(str(_result), _dest)\n"
            "        print('OK')\n"
            "    else:\n"
            "        print('NO_OUTPUT')\n"
            "except Exception as _e:\n"
            "    print('AGV_ERROR: ' + str(_e))\n"
            "    traceback.print_exc()\n"
        ),
    },
}
